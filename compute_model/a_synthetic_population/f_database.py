...
def create_table_syn_pop(pool, table_name):
    cols_table = {
        "geo_code": "VARCHAR(12) NOT NULL",
        "id_census_ind": "INT(11) NOT NULL",
        "weights": "INT(5) NOT NULL",
    }
    keys = "PRIMARY KEY (geo_code, id_census_ind) USING BTREE"
...
def create_table_syn_pop_quality(pool, table_name):
    cols_table = {
        "geo_code": "VARCHAR(12) NOT NULL",
...
if __name__ == '__main__':
    create_table_syn_pop(None, "computed_syn_pop")
    create_table_syn_pop_quality(None, "computed_syn_pop_quality")
