...
from compute_model.b_survey_association.k_format_persons import format_persons
...
def compute_travels_demand(geo_codes, emp_persons, emp_travels):
    ...
    # 5 - format persons
    print("format persons")
    syn_pop_persons = format_persons(syn_pop)
    ...
    return syn_pop_persons, syn_pop_travels_f, analysis
...
if __name__ == '__main__':
    ...
    persons, travels, analysis = compute_travels_demand(["79048"], emp_persons, emp_travels)
