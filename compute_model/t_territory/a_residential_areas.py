...
from compute_model.years import COG, year_gridded_pop, year_dossier_complet


def get_gridded_population(geo_codes):
    result = db_request(
...
def get_missing_gridded_population(geo_codes):
    result = db_request("""
                ...
                AND dc.year_data = :year_data
                AND dc.year_cog = :year_cog
