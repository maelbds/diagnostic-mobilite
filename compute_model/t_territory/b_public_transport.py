...
from compute_model.years import year_train_stations, COG_train_stations
...
def get_train_stations(geo_codes):
    result = db_request(
        """ SELECT id, name, lat, lon
            ...
            {
                "geo_codes": geo_codes,
                "year_data": year_train_stations,
                "year_cog": COG_train_stations
            }
    )
...
def get_pt_stops(geo_codes):
    ...
    all_pt_stops = all_pt_stops.dropna(subset=["lat", "lon"])
