...
sources = {
    ...
    "esrdatagouv": {
        "name": "Etablissements (Ministère de l'Enseignement supérieur, de la Recherche et de l'Innovation 2017)",
    ...
    "educationdatagouv": {
        "name": "Etablissements (Ministère de l'Éducation nationale, de la Jeunesse et des Sports 2023)",
