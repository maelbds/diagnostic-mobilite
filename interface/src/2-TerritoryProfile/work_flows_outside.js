...
export const work_flows_outside = new Indicator({
    indicator: "work_flows_outside",
    label: "flux domicile → travail (depuis les territoires extérieurs)",
    data_source: "verified",
    description: "Les flux représentés concernent les actifs de 15 ans ou plus ayant un emploi, habitant en dehors du territoire d'étude mais y travaillant. Ils relient leur commune de résidence et la commune dans laquelle ils déclarent travailler. Il mesure donc un nombre de « migrants alternants » ou « navettes » et non un nombre de déplacements effectifs. La fréquence (quotidienne, hebdomadaire, etc.) des déplacements n’est pas observée.",
    ...
    datasets_names: ["territory/work_flows_outside"]
})
