...
class FlowsOD_all extends React.Component {
  getCommunesMap(unit, unit_label, unit_legend, flows_limit){
    ...
    /* FLOWS */
    let flows_od = territory.travels_analysis["3_flows"].flows_commune_home_work[unit];
  ...
  getCommunesTable(unit, unit_label, unit_legend){
    ...
    let name_csv= "flux_domicile_travail_entre_communes_" + unit_label
  ...
  componentDidMount() {
    // --- init map
    let mymap = this.mymap = getMyMap("flows_od_home_work", true, 0.3);
    // --- add layers
            ...
            <div className="col">
                ...
                <div className="row">
                  <div className="col-12">
                    <h3 className="mb-3">principaux flux DOMICILE→TRAVAIL ENTRE COMMUNES</h3>
                  </div>
                </div>
