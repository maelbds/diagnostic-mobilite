    ...
    <div className="col-12">
      ...
      <p className="mb-2"><i>(population de l'aire)</i></p>
          ...
          {[0, 1, 2, 3].map((i)=>
            <div className="row">
              <div className="col-auto">
                <div className="row no-gutters align-items-center">
                  <div className="col-auto mr-1">
                    <div style={{height: "15px", width: "30px", backgroundColor: typo_zaav[i].couleur_pole}}></div>
                  </div>
                  <div className="col">
                    <p>Pôle</p>
                  </div>
              ...
              <div className="col-auto">
                <div className="row no-gutters align-items-center">
                  <div className="col-auto mr-1">
                    <div style={{height: "15px", width: "30px", backgroundColor: typo_zaav[i].couleur_couronne}}></div>
                  </div>
                  <div className="col">
                    <p>Couronne</p>
                  </div>
          ...
          <div className="row no-gutters align-items-center mb-4">
            <div className="col-auto mr-1">
              <div style={{height: "15px", width: "30px", backgroundColor: typo_zaav[4].couleur}}></div>
            </div>
            <div className="col">
