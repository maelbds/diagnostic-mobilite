...
class DataSelectionButtonFilterRadio extends React.Component {
          ...
          <div className="row justify-content-between align-items-center">
            <div className="col">
              ...
              <p className={selected_indicator.map((i)=>i.indicator).includes(ind.indicator) ? "mb-1 mt-1 datalist selected" : "mb-1 mt-1 datalist"}
                 ...
                 <span className={"ml-1 mr-2 material-symbols-outlined radio_button"}>{selected_indicator.map((i)=>i.indicator).includes(ind.indicator) ? "radio_button_checked" : "radio_button_unchecked"}</span>
                 {ind.label}
...
export default DataSelectionButtonFilterRadio;
