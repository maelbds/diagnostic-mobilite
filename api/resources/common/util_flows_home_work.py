...
from data_manager.sources.sources import get_years_for_source

WORK_FLOWS_THRESHOLD_FLOW = 25
WORK_FLOWS_THRESHOLD_DISTANCE = 80 # km

year_mobpro = get_years_for_source("insee_mobpro_flows_light")[0]
...
def get_flows_home_work(geo_codes):
    ...
    flows = flows.loc[mask_inside_perimeter_flows & mask_significant_flows]
    return flows
