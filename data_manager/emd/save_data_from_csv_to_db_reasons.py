...
def get_data_from_csv():
    data = pd.read_csv(
        "data/all/reasons.csv",
        sep=";", dtype=str)

    return data


def load_emd_reasons(pool):
    table_name = "emd_reasons"
    ...
    cols_table = {
        ...
        "id_main_reason": "INT(2) NOT NULL"
    }
    keys = "PRIMARY KEY (id) USING BTREE, KEY (id_main_reason) USING BTREE"
