...
def create_table_datasets(pool):
    table_name = "datagouv_pt_datasets"
    cols_table = {
...
def create_table_agency(pool):
    table_name = "datagouv_pt_agency"
    cols_table = {
        "datagouv_id": "VARCHAR(50) NOT NULL",
...
def create_table_calendar(pool):
    table_name = "datagouv_pt_calendar"
    cols_table = {
        "datagouv_id": "VARCHAR(50) NOT NULL",
...
def create_table_geocodes(pool):
    table_name = "datagouv_pt_geocodes"
    cols_table = {
    ...
    keys = "PRIMARY KEY (geo_code, datagouv_id, route_id, main_trip_id) USING BTREE, KEY (geo_code) USING BTREE"

    create_new_table(pool, table_name, cols_table, keys)


def create_table_routes(pool):
    table_name = "datagouv_pt_routes"
    cols_table = {
        "datagouv_id": "VARCHAR(50) NOT NULL",
        "route_id": "VARCHAR(200) NOT NULL",
...
def create_table_stops(pool):
    table_name = "datagouv_pt_stops"
    cols_table = {
        "datagouv_id": "VARCHAR(50) NOT NULL",
...
def create_table_stop_times(pool):
    table_name = "datagouv_pt_stop_times"
    cols_table = {
        "datagouv_id": "VARCHAR(50) NOT NULL",
...
def create_table_trips(pool):
    table_name = "datagouv_pt_trips"
    cols_table = {
        "datagouv_id": "VARCHAR(50) NOT NULL",
        "trip_id": "VARCHAR(150) NOT NULL",
