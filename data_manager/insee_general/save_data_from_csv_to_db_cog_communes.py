...
def download_file(id, name, table_name, label, link, reference, year_data, year_cog):
    if year_cog == "2021":
        f = {
            ...
            "url": link,
            "dir": f"data/{year_cog}",
            "zip_name": f"commune{year_cog}.zip",
            "file_name": f"commune{year_cog}.csv",
        }
        ...
        f = {
            ...
            "dir": f"data/{year_cog}",
            "zip_name": None,
            "file_name": f"v_commune_{year_cog}.csv",
        }
...
def load_cog_communes(pool):
    table_name = "insee_cog_communes"
    cols_table = {
    ...
    keys = "PRIMARY KEY (COM, year_cog) USING BTREE"
