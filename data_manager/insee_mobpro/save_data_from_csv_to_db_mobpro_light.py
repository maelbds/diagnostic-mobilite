...
def get_data_from_csv(file_name, id, name, table_name, label, link, reference, year_data, year_cog):
    cols = ["COMMUNE", "ARM", "DCFLT", "DCLT", "IPONDI", "TRANS", "CS1"]
...
def load_mobpro_flows_light(pool):
    table_name = "insee_mobpro_flows_light"
